...
public class SecurityConfig {
	...
	public CorsConfigurationSource apiCorsConfigurationSource() {
		...
		config.setAllowedOrigins(List.of("http://localhost:3000", "http://localhost:8080", "http://127.0.0.1:5500","https://quantitymeasurementapp-frontend-production-4a1a.up.railway.app"));
