...
public class QuantityMeasurementEntityTest {
	...
	public void givenValidParameters_WhenEntityCreated_ShouldMapFieldsCorrectly() {
		QuantityMeasurementEntity entity = new QuantityMeasurementEntity(1.0, "KILOGRAM", "WeightUnit", 1000.0, "GRAM",
				"WeightUnit", "ADD", 2.0, "KILOGRAM", "WeightUnit", "Success", false, "null");
